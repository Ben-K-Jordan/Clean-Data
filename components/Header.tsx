...
export default function Header() {
  return (
    <header className="bg-p-fill-brand">
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <svg className="w-7 h-7" viewBox="0 0 109.5 124.5" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-white/50 text-sm ml-1 hidden sm:inline">
            /
          </span>
